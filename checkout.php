	...
	<div id="page">
		...
		?>
			...
			<div class="container">
				...
				<form method="POST" name="check" action="insert_address.php" class="colorlib-form">
				<div class="row">
					<div class="col-lg-8">
					...
					<div class="col-lg-4">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<p> <button type="submit" onclick="validate1(event)" class="btn btn-primary">Place an order</button></p>
							</div>
						</div>
				</form>
